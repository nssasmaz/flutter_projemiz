...
class OturumAc2 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    TextEditingController form_kulaniciAdi = new TextEditingController();
    TextEditingController form_sifre = new TextEditingController();
                    ...
                    child: Column(
                      ...
                      children: [
                        TextField(
                          ...
                          onChanged: (yazi) {
                            form_kullaniciAdi.text = yazi;
                          },
                        ),
                        SizedBox(height: 20),
                        TextField(
                          obscureText: true,
                          controller: form_sifre,
                          style: TextStyle(
                              color: Colors.white, fontWeight: FontWeight.bold),
                          decoration: InputDecoration(
                              enabledBorder: const OutlineInputBorder(
